                ...
                <div class="register-box col-md-6 m-auto">
                    <div class="card">
                        <div class="card-body register-card-body">
                            ...
                            <form action="<?php echo site_url('Dashboard/update') ?>" method="post">
                                <?php echo csrf_field() ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Enter your Name" value="<?php echo $single_user['name'] ?>">
                                    <span class="text-danger"><?php echo isset($validation)?  display_error($validation,'name'):'' ?></span>
                                </div>
                                <div class="form-group">
                                    <lable for="email">Email</lable>
                                    <input type="text" class="form-control" id="email" name="email" placeholder="example@example.com" value="<?php echo $single_user['email'] ?>">
                                    <span class="text-danger"><?php echo isset($validation)?  display_error($validation,'email'):'' ?>
                                </div>
<!--                                <div class="form-group my-2">-->
<!--                                    <lable for="password">Password</lable>-->
<!--                                    <input type="password" class="form-control" id="password" name="password" placeholder="Enter Password" value="--><?php //echo $single_user['password'] ?><!--">-->
...
<!--                                    <input type="password" class="form-control" id="cpassword" name="cpassword" placeholder="Enter Confirmation Password" value="--><?php //echo $single_user['cpassword'] ?><!--">-->
<!--                                    <span class="text-danger">--><?php //echo isset($validation)?  display_error($validation,'cpassword'):'' ?>
<!--                                </div>-->
                                <div class="form-group">
                                    <lable for="role">Role</lable>
                                    <select name="role" id="role">
                                        <option <?php echo $single_user['role']==0?'selected':'' ?> value="0">Customer</option>
                                        <option <?php echo $single_user['role']==1?'selected':'' ?> value="1">Administrator</option>
                                    </select>
                                </div>
                                <div class="form-group">
