...
$("#form1").submit(function(e) {
    ...
    if (name == '') {
        ...
        $('#pName').remove();
        $('#divName').append('<p id="pName" style="color:red;"><small>The admin name is required.</small></p>');
        $("#btnSubmit").attr("disabled", true);
    ...
    if (password == '') {
        ...
        $('#pPassword').remove();
        $('#divPassword').append('<p id="pPassword" style="color:red;"><small>The password is required.</small></p>');
        $("#btnSubmit").attr("disabled", true);
    ...
    if (index_number == '' || name == '' || address == '' || gender == '' ||  phone == '' || email == '' || image == '' || password == '' || telformat.test(phone) == false) {
